    ...
    with window("Dear PyGui Demo", x_pos=100, y_pos=100, width=800, height=800, on_close=on_demo_close):
                        ...
                        with group(f"v group 2{i}##demo"):
                            ...
                            for j in range(0, 4):
                                add_slider_float(f"##v{j}{i}##demo", default_value=values[j], vertical=True,
                                                 max_value=1.0, height=50, source=f"v{j}")
                                if i != 3:
                                    add_same_line()
        ...
        with collapsing_header("Drawings##demo"):
            ...
            with group("Drawing Controls Group##demo"):
                add_slider_float("X Origin##demo", vertical=True, min_value=-100, max_value=100, default_value=0,
                                 callback=UpdateDrawing)
                add_same_line(spacing=20)
                add_slider_float("Y Origin##demo", vertical=True, min_value=-100, max_value=100, default_value=0,
                                 callback=UpdateDrawing)
            ...
            draw_rectangle("drawing##widget##demo", (0, 500), (800, 0), (255, 0, 0, 255), fill=(0, 0, 25, 255),
                           rounding=12, thickness=1.0)
            draw_line("drawing##widget##demo", (10, 10), (100, 100), (255, 0, 0, 255), 1)
            draw_triangle("drawing##widget##demo", (300, 500), (200, 200), (500, 200), (255, 255, 0, 255),
                          thickness=3.0)
            draw_quad("drawing##widget##demo", (50, 50), (150, 50), (150, 150), (50, 150), (255, 255, 0, 255),
                      thickness=3.0)
            ...
            draw_polyline("drawing##widget##demo", ((320, 490), (185, 200), (500, 710)), (255, 255, 0, 255),
                          thickness=1.0)
            draw_polygon("drawing##widget##demo", ((363, 471), (153, 498), (59, 220), (363, 471)), (255, 125, 0, 255),
                         thickness=1.0, fill=(255, 125, 0, 50))
            draw_bezier_curve("drawing##widget##demo", (50, 200), (150, 250), (300, 150), (600, 250),
                              (255, 255, 0, 255), thickness=2.0)
        ...
        with collapsing_header("Plots##demo"):
            ...
            with tree_node("Scatter Plots##demo"):
                ...
                add_scatter_series("Scatter Plot##demo", "Data 2", scatter_data2, size=7, marker=mvPlotMarker_Square,
                                   fill=[255, 0, 0, 100])
            ...
            with tree_node("Error Bars##demo"):
                ...
                error_data1 = [[1, 1, 0.2, 0.4], [2, 2, 0.4, 0.2], [3, 5, 0.2, 0.4], [4, 3, 0.6, 0.8],
                               [5, 4, 0.4, 0.6]]  # bars
                error_data2 = [[1, 8, 0.2, 0.4], [2, 8, 0.4, 0.2], [3, 9, 0.2, 0.4], [4, 7, 0.6, 0.8],
                               [5, 8, 0.4, 0.6]]  # lines
            ...
            with tree_node("Pie Charts##demo"):
                ...
                add_pie_series("##PieChart1##demo", "PieChart1", [["fish", 0.25], ["Cow", 0.30], ["Chicken", 0.30]],
                               0.5, 0.5, 0.5)
                add_pie_series("##PieChart2##demo", "PieChart2", [["A", 1], ["B", 1], ["C", 2], ["D", 3], ["E", 5]],
                               0.5, 0.5, 0.5,
